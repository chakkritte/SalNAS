...
teacher = copy.deepcopy(subnet).to(device)
...
def train_ofa(model, optimizer, loader, epoch, device, args, args_super, teacher , alpha_t):
    model.train()
    teacher.eval()
...
for epoch in range(0, args.no_epochs):
    ...
    loss = train_ofa(student, optimizer , train_loader, epoch, device, args, args_super, teacher, alpha_t)
