...
from .salnas_static import MobileNetV3
...
class OFAMobileNetV3(MobileNetV3):
    def __init__(
        ...
        self.ch_eml.append(input_channel)
        ...
        self.ch_eml.append(final_expand_width)
        ...
        self.decode_channel = [self.ch_eml[6], self.ch_eml[4], self.ch_eml[2], self.ch_eml[1], self.ch_eml[0], self.ch_eml[0]]
        self.decode_output0 = self._make_output(self.decode_channel[0], self.decode_channel[1])
        self.decode_output1 = self._make_output(self.decode_channel[1]*2, self.decode_channel[2])
        self.decode_output2 = self._make_output(self.decode_channel[2]*2, self.decode_channel[3])
        self.decode_output3 = self._make_output(self.decode_channel[3]*2, self.decode_channel[4])
        self.decode_output4 = self._make_output(self.decode_channel[4]*2, self.decode_channel[5])
        self.decode_output5 = self._make_output(self.decode_channel[5], self.decode_channel[5])
        self.decode_output6 = self._make_output_(self.decode_channel[5])
    ...
    def get_active_subnet(self, preserve_weight=True):
        ...
        decode_output = [copy.deepcopy(self.decode_output0), 
                        copy.deepcopy(self.decode_output1), 
                        copy.deepcopy(self.decode_output2), 
                        copy.deepcopy(self.decode_output3), 
                        copy.deepcopy(self.decode_output4), 
                        copy.deepcopy(self.decode_output5), 
                        copy.deepcopy(self.decode_output6)]
        ...
        _subnet.set_decode(decode_output, ch_index, self.output_size)
