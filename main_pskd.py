...
from salnas.core.trainer import train_ps_kd
...
parser.add_argument('--kd_mode', type=str, default="ps", help='none | pkd | self | ps')
...
args.save = '{}/{}-{}-ps-{}'.format(args.output_dir, args.dataset, args.student, time.strftime("%Y%m%d-%H%M%S"))
...
for epoch in range(0, args.no_epochs):
    ...
    loss = train_ps_kd(student, optimizer, train_loader, epoch, device, args, teacher, scaler, alpha_t)
