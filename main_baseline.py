...
from salnas.core.trainer import train_baseline
...
parser.add_argument('--kd_mode', type=str, default="none", help='none | pkd | self')
...
args.save = '{}/{}-{}-none-{}'.format(args.output_dir, args.dataset, args.student, time.strftime("%Y%m%d-%H%M%S"))
